...
const FOUNDATION_ADDRESS = "TW6HYNJrc7K2fQR5Tuki766W6L42UahYWR";
...
class App extends React.Component {
  constructor(props) {
    ...
    this.updateGetBalanceInputValue = this.updateGetBalanceInputValue.bind(
      this
    );
    this.updateTransferInputValue = this.updateTransferInputValue.bind(this);
    this.updateTransferAmountInputValue = this.updateTransferAmountInputValue.bind(
      this
    );
    this.updateContractAddressInput = this.updateContractAddressInput.bind(
      this
    );
    this.updateBurnAmountInputValue = this.updateBurnAmountInputValue.bind(
      this
    );
    this.updateTansferFromFromInputValue = this.updateTansferFromFromInputValue.bind(
      this
    );
    this.updateTansferFromToInputValue = this.updateTansferFromToInputValue.bind(
      this
    );
    this.updateTansferFromAmountInputValue = this.updateTansferFromAmountInputValue.bind(
      this
    );
  ...
  async updateContractAddressInput(evt) {
    ...
    await this.setState({
      ...
      totalSupply:
        (await Utils.contract.totalSupply().call()).toNumber() / 100000000,
  ...
  async getBalance(_getbalanceaddress) {
    const balance =
      (await Utils.contract.balanceOf(_getbalanceaddress).call()).toNumber() /
      100000000;
  ...
  async TransferFrom(_from, _to, _amount) {
    const allowance = await Utils.contract
      .allowance(_from, this.state.tronwebaddress)
      .call();
  ...
  updateTansferFromFromInputValue(evt) {
    ...
    console.log(
      "transferfromfromaddress : ",
      this.state.transferfromfromaddress
    );
  }
      ...
      <div className="row">
        <div className="col-lg-12 text-center">
          ...
          <div className="topnav">
            <img src={"Minddeft.png"} width="200px" />
          </div>
          <hr
            style={{ color: "white", backgroundColor: "white", height: 0.5 }}
          />

          <h1 style={{ color: "white" }}>Tron TRC20 Token</h1>
          <hr
            style={{ color: "white", backgroundColor: "white", height: 0.5 }}
          />
          ...
          <button
            ...
            onClick={(event) => {
              ...
              this.Transfer(
                ...
                this.state.transferamount * 100000000
              );
            }}
          >
            Transfer
          ...
          <input
            style={{ width: "400px" }}
            value={this.state.transferfromfromaddress}
            onChange={this.updateTansferFromFromInputValue}
          />
          <p> To : </p>
          <input
            style={{ width: "400px" }}
            value={this.state.transferfromtoaddress}
          ...
          <button
            ...
            onClick={(event) => {
              ...
              this.TransferFrom(
                this.state.transferfromfromaddress,
                this.state.transferfromtoaddress,
                this.state.transferfromamount * 100000000
              );
            }}
          >
            Transfer From
          ...
          <button
            ...
            onClick={(event) => {
              ...
              this.Approve(
                ...
                this.state.approveamount * 100000000
              );
            }}
          >
            Approve
          ...
          <input
            style={{ width: "200px" }}
            value={this.state.burnfromfrom}
            onChange={this.updateBurnFromFromValue}
          />
          <p> Amount to burn : </p>
          <input
            style={{ width: "200px" }}
            value={this.state.burnfromamount}
          ...
          <button
            ...
            onClick={(event) => {
              event.preventDefault();
              this.BurnFrom(
                this.state.burnfromfrom,
                this.state.burnfromamount * 100000000
              );
            }}
          >
            Burn From
